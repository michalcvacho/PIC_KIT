 ...
 *
 *********************************************************************
 * FileName:        rtcc_set_time_date_lib.c
 * Dependencies:	Rtcc.h
 *
 * Processor:       PIC32
 *
