...
#include "_spi_got_new_spi_port_question.h"
  ...
  //Do nothing.  SPI module is responsible for port configurations
#else
...
/*********************************************************************
 * Function:        void SpiChnOpen(SpiChannel chn, SpiOpenFlags oFlags, unsigned int fpbDiv)
 *
 ...
 ********************************************************************/
void SpiChnOpen(SpiChannel chn, SpiOpenFlags oFlags, unsigned int fpbDiv)
{
