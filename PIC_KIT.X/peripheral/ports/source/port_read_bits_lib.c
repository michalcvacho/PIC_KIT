/*********************************************************************
 *
 *                  PORTReadBits lib function
 *
 *********************************************************************
 * FileName:        port_read_bits_lib.c
 * Dependencies:
 *
 * Processor:       PIC32
 *
 ...
 *
 * Function:        unsigned int	PORTReadBits(IoPortId portId, int bits);
 *
 ...
 *
 * Example:			int value = PORTReadBits(IOPORT_B, BIT_2 | BIT_4);
 *
 ...
 *****************************************************************************/
	unsigned int	PORTReadBits(IoPortId portId, unsigned int bits)
	{
		...
		return(pDcpt->pPortReg->port & bits);
	}
