 ...
 *
 *********************************************************************
 * FileName:        dma_chn_get_src_pnt_lib.c
 * Dependencies:	Dma.h
 *
 * Processor:       PIC32
 *
 ...
 * 					It is the current offset, 0 to DmaGetMaxTxferSize(), in the source transfer buffer.
 *
 * Note:            None
 ********************************************************************/
int DmaChnGetSrcPnt(DmaChannel chn)
{
	return (_DmaMapTbl+chn)->sptr;	// read the src pointer
}
